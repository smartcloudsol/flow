...
export interface FormAttributes {
  ...
  discussionSignInRequiredMessage?: string;
  discussionSignInLabel?: string;
  discussionPermissionDeniedMessage?: string;
...
export interface CheckboxGroupFieldAttributes
  ...
  required?: boolean;
  optionsText?: string;
  manualOptionsText?: string;
  exclusiveValuesText?: string;
  optionsSource?: OptionsSource;
  apiEndpoint?: string;
  apiMethod?: "GET" | "POST";
  apiHeaders?: string;
