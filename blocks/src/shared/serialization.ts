...
import { parseOptions, parseTextList } from "./field-utils";
import {
...
function normalizeFieldAttributes(field: FieldConfig): FieldConfig {
  ...
  if (
    mutableField.type === "checkbox-group" &&
    !Array.isArray(mutableField.manualOptions) &&
    typeof mutableField.manualOptionsText === "string"
  ) {
    mutableField.manualOptions = parseOptions(mutableField.manualOptionsText);
  }

  if (
    mutableField.type === "checkbox-group" &&
    !Array.isArray(mutableField.exclusiveValues) &&
    typeof mutableField.exclusiveValuesText === "string"
  ) {
    mutableField.exclusiveValues = parseTextList(
      mutableField.exclusiveValuesText,
    );
  }
  ...
  if (mutableField.type === "checkbox-group") {
    delete mutableField.manualOptionsText;
    delete mutableField.exclusiveValuesText;
  }
