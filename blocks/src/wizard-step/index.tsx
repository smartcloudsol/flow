...
import { WizardStepIcon } from "../icons";
...
registerBlockType(metadata.name, {
  ...
  edit: Edit,
  save: Save,
  deprecated: getLegacySerializedContainerBlockDeprecations("wizard-step", metadata.attributes as Record<string, BlockAttribute>),
  icon: { src: <WizardStepIcon /> },
});
