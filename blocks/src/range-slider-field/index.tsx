...
import { RangeSliderIcon } from "../icons";
...
registerBlockType(metadata.name, {
  ...
  edit: Edit,
  save: Save,
  deprecated: getLegacySerializedLabeledLeafBlockDeprecations("range-slider", metadata.attributes as Record<string, BlockAttribute>),
  icon: { src: <RangeSliderIcon /> },
});
