      ...
      <InspectorControls>
        <PanelBody title={__("Slider Field Settings", TEXT_DOMAIN)}>
          ...
          <NumberControl
            ...
            help={__(
              "Number of decimal places shown in the slider value.",
              TEXT_DOMAIN,
            )}
          />
          <NumberControl
            ...
            help={__(
              "Custom size of the draggable thumb in pixels.",
              TEXT_DOMAIN,
            )}
          />
          <ToggleControl
          ...
          <ToggleSettingsSection
            ...
            items={[
              ...
              },
              {
                ...
                help: __(
                  "Show the current value when hovering the slider thumb.",
                  TEXT_DOMAIN,
                ),
              },
              {
                ...
                help: __(
                  "Keep the value label visible even when the slider is idle.",
                  TEXT_DOMAIN,
                ),
              },
              {
