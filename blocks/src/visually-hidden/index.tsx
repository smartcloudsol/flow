...
import { VisuallyHiddenIcon } from "../icons";
...
registerBlockType(metadata.name, {
  ...
  edit: Edit,
  save: Save,
  deprecated: getLegacySerializedContainerBlockDeprecations("visuallyhidden", metadata.attributes as Record<string, BlockAttribute>),
  icon: { src: <VisuallyHiddenIcon /> },
});
