...
import { FieldsetIcon } from "../icons";
...
registerBlockType(metadata.name, {
  ...
  edit: Edit,
  save: Save,
  deprecated: getLegacySerializedContainerBlockDeprecations("fieldset", metadata.attributes as Record<string, BlockAttribute>),
  icon: { src: <FieldsetIcon /> },
});
