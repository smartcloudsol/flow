...
function buildRoutingSystemPromptBlock(preset: AiRoutingPreset): string {
  ...
  return [
    ...
    "Use routing.outcomes for actionable next steps. Each outcome must contain a generic action-family type and a stable business key.",
    "Use outcome.type only for schema-allowed action families such as invoke_webhook, invoke_workflow, send_email, set_status, emit_event, or custom.",
    "Use outcome.key for the workflow-specific stable downstream branch key. Do not place workflow-specific business keys into outcome.type.",
